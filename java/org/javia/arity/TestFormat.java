    ...
    static boolean testSizeCases() {
        ...
        for (SizeCase c : sizeCases) {
            ...
            if (!truncated.equals(c.res)) {
                System.out.println("sizeTruncate(" + c.val + ", " + c.size + "): got '" + truncated + "' expected '" + c.res + "'");
                ret = false;
            }
        }
        return ret;
